...
export default function Publications() {
  ...
  return (
    <section id="publicaciones" className="max-w-6xl mx-auto px-6 py-16">
      ...
      <h3 className="mt-10 font-serif text-xl text-brand-800">Libros de autoría</h3>
        ...
        {books.map((b, i) => (
          <div key={i} className="card">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-serif text-[17px] text-brand-900 leading-snug">{b.title}</h4>
                <p className="text-sm text-brand-900/80 mt-2 leading-relaxed">{b.desc}</p>
              </div>
            </div>
          </div>
        ))}
      ...
      <h3 className="mt-10 font-serif text-xl text-brand-800">Artículos y capítulos destacados</h3>
      ...
      <div className="mt-8 flex flex-wrap gap-3 text-sm">
        <a
          className="chip"
          href="https://scholar.google.com.mx/citations?user=xalUPyQAAAAJ&hl=es"
          target="_blank"
          rel="noreferrer"
        >
          Google Scholar
        ...
        <a
          className="chip"
          href="https://www.researchgate.net/profile/Gerardo-Alfaro-Calderon"
          target="_blank"
          rel="noreferrer"
        >
          ResearchGate
        ...
        <a
          className="chip"
          href="https://www.fcca.umich.mx/doctorado/Perfil.php?ID=Alfaro"
          target="_blank"
          rel="noreferrer"
        >
          Perfil FCCA-UMSNH
